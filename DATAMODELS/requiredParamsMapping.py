requiredParamsMap = {'aci_fabric_pod_policy_group': ['name*',
 ...
 'aci_interface_policy_leaf_profile': ['interface_profile*',
  ...
  'name_alias',
  'type'],
 'aci_cloud_ap': ['description', 'name', 'tenant', 'state'],
 'aci_l3out': ['tenant*',
  'l3out*',
  'domain*',
  'vrf*',
 ...
 'aci_access_span_filter_group_entry': ['filter_group*',
  ...
  'name_alias',
  'state'],
 'aci_cloud_vpn_gateway': ['tenant', 'cloud_context_profile', 'state'],
 'aci_cloud_cidr': ['address*',
  'description',
  'name_alias',
  'tenant',
  'cloud_context_profile',
 ...
 'aci_l3out_bgp_protocol_profile': ['tenant*',
  ...
  'state',
  'name_alias'],
 'aci_cloud_region': ['region', 'cloud', 'state'],
 ...
 'aci_l3out_bfd_multihop_interface_profile': ['tenant*',
  ...
  'state'],
 'aci_cloud_zone': ['name', 'cloud', 'region', 'state'],
 ...
 'aci_l2out_logical_node_profile': ['tenant*',
  ...
  'node_profile*',
  'state'],
 'aci_cloud_ctx_profile': ['description'],
