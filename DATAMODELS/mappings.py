ansibleToClass = {
    ...
    "aci_bgp_best_path_policy": "bgpBestPathCtrlPol",
    "aci_bgp_timers_policy": "bgpCtxPol",
    ...
    "aci_fabric_interface_policy_group": "fabricLePortPGrp, fabricSpPortPGrp",
    ...
    "aci_fabric_node_control" : "fabricNodeControl",
    "aci_fabric_pod_policy_group": "fabricPodPGrp",
    "aci_fabric_pod_selector" : "fabricPodS",
    ...
    "aci_fabric_wide_settings": "infraSetPol",
    ...
    "aci_interface_policy_leaf_fc_policy_group": "infraFcAccBndlGrp, infraFcAccPortGrp",
    ...
    "aci_interface_policy_spine_policy_group": "infraSpAccPortGrp",
    ...
    "aci_l3out_bgp_protocol_profile": "infraSpAccPortGrp", 
    ...
    "aci_match_as_path_regex_term": "rtctrlMatchAsPathRegexTerm",
    "aci_match_community_factor": "rtctrlMatchCommFactor",
    "aci_match_community_regex_term": "rtctrlMatchCommRegexTerm",
    "aci_match_community_term": "rtctrlMatchCommTerm",
    "aci_match_route_destination": "rtctrlMatchRtDest",
    "aci_match_rule" : "rtcrtlSubjP",
    "aci_node_mgmt_epg": "mgmtOoB",
    "aci_ntp_policy": "datetimePol",
    "aci_ntp_server": "datetimeNtpProvider",
    "aci_rest": "mgmtRsRestOutAtt",
    "aci_route_control_context": "rtcrtlCtxP",
    "aci_route_control_profile": "rtcrtlProfile",
    ...
    "aci_system_banner": "aaaPreLoginBanner",
    "aci_system_endpoint_controls": "epIpAgingP, epControlP, epLoopProtectP",
    "aci_system_global_aes_passphrase_encryption": "pkiExportEncryptionKey",
